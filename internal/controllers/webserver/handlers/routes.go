...
func (h *Handler) Register(e *echo.Echo) {
	...
	e.GET("/tenant/:tenant/site/:site/admin", func(c echo.Context) error { return h.ListUsers(c, "", "") }, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin", func(c echo.Context) error { return h.ListUsers(c, "", "") }, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/users", func(c echo.Context) error { return h.ListUsers(c, "", "") }, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/users", func(c echo.Context) error { return h.ListUsers(c, "", "") }, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/users/new", h.NewUser, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/users/import", h.ImportUsers, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/users/:uid/profile", h.EditUser, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/users/:uid/profile", h.EditUser, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/users/:uid/certificate", h.RequestUserCertificate, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/users/:uid/renewcertificate", h.RenewUserCertificate, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/users/new", h.AddUser, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/users/:uid/askconfirm", h.AskForConfirmation, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/users/:uid/confirmemail", h.SetEmailConfirmed, h.IsAuthenticated)
	e.DELETE("/tenant/:tenant/site/:site/admin/users/:uid", h.DeleteUser, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/sessions", func(c echo.Context) error { successMessage := ""; return h.ListSessions(c, successMessage) }, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/sessions/:token/delete", h.SessionDelete)
	e.DELETE("/tenant/:tenant/site/:site/admin/sessions/:token", h.SessionConfirmDelete, h.IsAuthenticated)
	...
	e.GET("/tenant/:tenant/site/:site/admin/metadata", h.OrgMetadataManager, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/metadata", h.OrgMetadataManager, h.IsAuthenticated)
	e.DELETE("/tenant/:tenant/site/:site/admin/metadata", h.OrgMetadataManager, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/smtp", h.SMTPSettings, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/smtp", h.SMTPSettings, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/smtp/test", h.TestSMTPSettings, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/settings", h.GeneralSettings, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/settings", h.GeneralSettings, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/update-agents", h.UpdateAgents, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/update-agents", h.UpdateAgents, h.IsAuthenticated)
	e.DELETE("/tenant/:tenant/site/:site/admin/update-agents", h.UpdateAgents, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/update-agents/confirm", h.UpdateAgentsConfirm, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/certificates", h.ListCertificates, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/certificates", h.CertificateConfirmRevocation, h.IsAuthenticated)
	e.DELETE("/tenant/:tenant/site/:site/admin/certificates", h.RevocateCertificate, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/restore", h.Restore, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/restore-messenger", h.RestoreMessenger, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/restore-messenger", h.RestoreMessenger, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/restore-updater", h.RestoreUpdater, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/restore-updater", h.RestoreUpdater, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/restore-agents", h.RestoreAgents, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/restore-agents", h.RestoreAgents, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/restore-database", h.RestoreDatabase, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/restore-database", h.RestoreDatabase, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/admin/update-servers", h.UpdateServers, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/update-servers", h.UpdateServers, h.IsAuthenticated)
	e.DELETE("/tenant/:tenant/site/:site/admin/update-servers/:serverId", h.UpdateServers, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/update-servers/confirm", h.UpdateServersConfirm, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/admin/confirm-delete-server/:serverId", h.DeleteServerConfirm, h.IsAuthenticated)
