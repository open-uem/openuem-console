...
func (h *Handler) Register(e *echo.Echo) {
	...
	e.GET("/admin", func(c echo.Context) error { return h.ListUsers(c, "", "", false) }, h.IsAuthenticated)
	e.POST("/admin", func(c echo.Context) error { return h.ListUsers(c, "", "", false) }, h.IsAuthenticated)
	e.GET("/admin/users", func(c echo.Context) error { return h.ListUsers(c, "", "", false) }, h.IsAuthenticated)
	e.POST("/admin/users", func(c echo.Context) error { return h.ListUsers(c, "", "", false) }, h.IsAuthenticated)
	...
	e.GET("/admin/sessions", func(c echo.Context) error { successMessage := ""; return h.ListSessions(c, successMessage, false) }, h.IsAuthenticated)
