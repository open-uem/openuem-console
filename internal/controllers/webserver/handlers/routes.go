...
func (h *Handler) Register(e *echo.Echo) {
	...
	e.GET("/computers/:uuid/logical-disks/:volume/bitlocker", func(c echo.Context) error { return h.BitLockerInfo(c, "") }, h.IsAuthenticated)
	e.GET("/computers/:uuid/logical-disks/:volume/bitlocker/info", func(c echo.Context) error { return h.BitLockerProgressInfo(c, "") }, h.IsAuthenticated)
	e.POST("/computers/:uuid/logical-disks/:volume/bitlocker/encrypt", h.BitLockerEncryptDisk, h.IsAuthenticated)
	e.POST("/computers/:uuid/logical-disks/:volume/bitlocker/decrypt", h.BitLockerDecryptDisk, h.IsAuthenticated)
	e.POST("/computers/:uuid/logical-disks/:volume/bitlocker/resume", func(c echo.Context) error { return h.BitLockerResumeSuspendProtection(c, true) }, h.IsAuthenticated)
	e.POST("/computers/:uuid/logical-disks/:volume/bitlocker/suspend", func(c echo.Context) error { return h.BitLockerResumeSuspendProtection(c, false) }, h.IsAuthenticated)
	e.POST("/computers/:uuid/logical-disks/:volume/bitlocker/enableautounlock", func(c echo.Context) error { return h.BitLockerAutoUnlock(c, true) }, h.IsAuthenticated)
	e.POST("/computers/:uuid/logical-disks/:volume/bitlocker/disableautounlock", func(c echo.Context) error { return h.BitLockerAutoUnlock(c, false) }, h.IsAuthenticated)
	e.POST("/computers/:uuid/logical-disks/:volume/bitlocker/passphrase", h.BitLockerChangePassphrase, h.IsAuthenticated)
	e.DELETE("/computers/:uuid/logical-disks/:volume/bitlocker/passphrase", h.BitLockerDeletePassphrase, h.IsAuthenticated)
	e.DELETE("/computers/:uuid/logical-disks/:volume/bitlocker/operation", h.BitLockerDeleteStalledOp, h.IsAuthenticated)
	e.POST("/computers/:uuid/logical-disks/:volume/bitlocker/unlockwithpass", h.BitLockerUnlockWithPassphrase, h.IsAuthenticated)
	e.POST("/computers/:uuid/logical-disks/:volume/bitlocker/addpassphrase", h.BitLockerAddPassphrase, h.IsAuthenticated)
	...
	e.GET("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker", func(c echo.Context) error { return h.BitLockerInfo(c, "") }, h.IsAuthenticated)
	e.GET("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker/info", func(c echo.Context) error { return h.BitLockerProgressInfo(c, "") }, h.IsAuthenticated)
	e.POST("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker/encrypt", h.BitLockerEncryptDisk, h.IsAuthenticated)
	e.POST("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker/decrypt", h.BitLockerDecryptDisk, h.IsAuthenticated)
	e.POST("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker/resume", func(c echo.Context) error { return h.BitLockerResumeSuspendProtection(c, true) }, h.IsAuthenticated)
	e.POST("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker/suspend", func(c echo.Context) error { return h.BitLockerResumeSuspendProtection(c, false) }, h.IsAuthenticated)
	e.POST("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker/enableautounlock", func(c echo.Context) error { return h.BitLockerAutoUnlock(c, true) }, h.IsAuthenticated)
	e.POST("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker/disableautounlock", func(c echo.Context) error { return h.BitLockerAutoUnlock(c, false) }, h.IsAuthenticated)
	e.POST("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker/passphrase", h.BitLockerChangePassphrase, h.IsAuthenticated)
	e.DELETE("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker/passphrase", h.BitLockerDeletePassphrase, h.IsAuthenticated)
	e.DELETE("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker/operation", h.BitLockerDeleteStalledOp, h.IsAuthenticated)
	e.POST("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker/unlockwithpass", h.BitLockerUnlockWithPassphrase, h.IsAuthenticated)
	e.POST("/tenant/:tenant/computers/:uuid/logical-disks/:volume/bitlocker/addpassphrase", h.BitLockerAddPassphrase, h.IsAuthenticated)
	...
	e.GET("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker", func(c echo.Context) error { return h.BitLockerInfo(c, "") }, h.IsAuthenticated)
	e.GET("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker/info", func(c echo.Context) error { return h.BitLockerProgressInfo(c, "") }, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker/encrypt", h.BitLockerEncryptDisk, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker/decrypt", h.BitLockerDecryptDisk, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker/resume", func(c echo.Context) error { return h.BitLockerResumeSuspendProtection(c, true) }, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker/suspend", func(c echo.Context) error { return h.BitLockerResumeSuspendProtection(c, false) }, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker/enableautounlock", func(c echo.Context) error { return h.BitLockerAutoUnlock(c, true) }, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker/disableautounlock", func(c echo.Context) error { return h.BitLockerAutoUnlock(c, false) }, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker/passphrase", h.BitLockerChangePassphrase, h.IsAuthenticated)
	e.DELETE("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker/passphrase", h.BitLockerDeletePassphrase, h.IsAuthenticated)
	e.DELETE("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker/operation", h.BitLockerDeleteStalledOp, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker/unlockwithpass", h.BitLockerUnlockWithPassphrase, h.IsAuthenticated)
	e.POST("/tenant/:tenant/site/:site/computers/:uuid/logical-disks/:volume/bitlocker/addpassphrase", h.BitLockerAddPassphrase, h.IsAuthenticated)
