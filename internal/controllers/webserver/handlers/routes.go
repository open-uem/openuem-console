...
func (h *Handler) Register(e *echo.Echo) {
	...
	e.GET("/admin/users/:uid/certificate", h.RequestUserCertificate, h.IsAuthenticated)
	e.GET("/admin/users/:uid/renewcertificate", h.RenewUserCertificate, h.IsAuthenticated)
