...
func (h *Handler) GetCertificates(c echo.Context, successMessage string) error {
	...
	return RenderView(c, admin_views.CertificatesIndex(" | Certificates", admin_views.Certificates(c, p, f, h.SessionManager, l, certTypes, certificates, successMessage, false)))
}
